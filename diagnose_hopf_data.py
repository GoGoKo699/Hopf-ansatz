...
def build_report(
    ...
    lines.append("- The modes use cost and Hopf-coordinate-gradient information. Nonzero last_line_evals are line-search or safeguard oracle calls, not shot counts in the infinite-shot synthetic data.")
